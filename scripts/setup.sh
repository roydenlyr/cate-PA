...
echo "  2. From FS1, copy SSH key: ssh-copy-id cate@{This Pi's IP Address}"
echo "  3. Update stations.json on FS1 with this station's ID and IP"
echo "  4. Reboot all stations:    cd ~/cate-PA/scripts && ./reboot_all.sh"
echo "========================================="
